...
export default class Bot 
{
  ...
  */
  ...
  ) 
  {
    ...
    var postNum = 40; // Specify the number of recent posts to compare from the logged in user's feed.
    var bskyFeedAwait = await this.#agent.getAuthorFeed({actor: "testometer.bsky.social", limit: postNum,}); // Get a defined number + 2 of most recent posts from the logged in user's feed.
